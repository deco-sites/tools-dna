...
function WishlistButton({
  ...
  return (
    <Button
      class={variant === "icon"
        ? "btn-circle btn-ghost gap-2 flex justify-center items-center"
        : "btn-primary btn-outline gap-2 flex justify-center items-center"}
      ...
      onClick={async (e) => {
        ...
        if (!isUserLoggedIn) {
          globalThis.alert(
            "Por favor, realize login para adicionar aos Favoritos",
          );
